...
CalendarApp::CalendarApp() : Adafruit_GFX(800, 480) {
    // 申请显存 (约 96KB)
...
void CalendarApp::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
// =========================================================
void CalendarApp::drawCalendarLayout(struct tm *now) {
    if (!buffer) return;
